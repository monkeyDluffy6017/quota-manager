...
func runAllTests(ctx *TestContext) []TestResult {
	...
	testCases := []struct {
		...
		// GitHub Star Check Tests
		{"GitHub Star Check - Enabled User Starred", testGithubStarCheckEnabledUserStarred},
		{"GitHub Star Check - Enabled User Not Starred", testGithubStarCheckEnabledUserNotStarred},
		// {"GitHub Star Check - Disabled", testGithubStarCheckDisabled},
	}
